...
class WABVideos extends StatefulWidget {
  @override
  _WABVideosState createState() => _WABVideosState();
}

class _WABVideosState extends State<WABVideos> {
  final Directory _videoDirectory = new Directory('/storage/emulated/0/WhatsApp Business/Media/.Statuses');
  @override
